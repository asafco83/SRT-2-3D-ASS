...
You can download the application from the [Releases](/releases) page. We provide two different versions for Windows users—choose the one that best fits your needs:
